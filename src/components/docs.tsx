...
export function Swatch({
  ...
  return (
    <button
      ...
      className="group text-left rounded-xl bg-card overflow-hidden shadow-[inset_0_0_0_1px_var(--border),var(--shadow-xs)] hover:shadow-[inset_0_0_0_1px_var(--border),var(--shadow-md)] transition-shadow"
    >
      <div
