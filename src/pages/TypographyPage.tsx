...
const TEXT: Row[] = [
  ...
  { name: "Eyebrow", spec: "Instrument Sans · 11 · uppercase", role: "Overline above a title or section.", code: "text-[11px] uppercase", status: "ok", text: "Last 24 hours", style: sans(11, { fontWeight: 500, textTransform: "uppercase", letterSpacing: "0.08em", color: "var(--fg-2)" }) },
